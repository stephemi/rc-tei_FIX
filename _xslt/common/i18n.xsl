...
<xsl:stylesheet exclude-result-prefixes="xd tei fotex fo" version="1.0" xmlns:fo="http://www.w3.org/1999/XSL/Format"
	xmlns:fotex="http://www.tug.org/fotex" xmlns:tei="http://www.tei-c.org/ns/1.0" xmlns:xd="http://www.pnp-software.com/XSLTdoc"
	xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xd:doc type="stylesheet">
		<xd:short> TEI stylesheet definitions common for all of HTML, FO and LaTeX outputs </xd:short>
...
-->
		...
		<!-- <xsl:if test="not($wcPage = '')">
			<p>
				<xsl:text> (see also </xsl:text>
				<a href="{$wcPage}">Works Cited</a>
				<xsl:text>)</xsl:text>
				</p>
				</xsl:if> -->
	</xsl:template>
	...
	<xd:doc class="localisation" type="string"> The language to use when generating text (use ISO 2-letter codes)</xd:doc>
	<xsl:param name="lang">en</xsl:param>
	<xd:doc class="localisation">
		<xd:short>[common] Prefix text before an auto-generated table of contents </xd:short>
		<xd:detail> </xd:detail>
	</xd:doc>
	<xd:doc class="localisation" type="string"> The language the text is in (use ISO 2-letter codes)</xd:doc>
